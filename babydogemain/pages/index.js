          ...
          <div className="flex justify-center  ">
            <div className="w-full overflow-hidden  items-center flex flex-col text-center">
              ...
              <div className="rounded-lg w-full md:w-1/3 bg-[#191924] p-8 mt-24 text-start font-extralight">
                ...
                everybody regardless of status. $BABYDOGE began as a dream to create
                ...
                spread amongst the early supporters of Baby Doge who were there
                ...
                of Baby Doge was to be the new dawn for so many who were suffering
                ...
                <br></br>
                <br></br> A dark force took control of $BABYDOGE, using obfuscation
                to hide his real intentions. Rumor has it that this dark force
                held a majority stake in Baby Doge through thousands of wallets that
                were under his control. Jackson abandoned his army and failed to
                ship a meaningful technology roadmap, which turned Baby Doge into a
                perpetual bear market nightmare for those who had remained loyal
                to its original vision and faithful to the Jackson cult.<br></br>
                <br></br> A key contributor to the ideation and creation of
                Baby Doge, known only as The Dogfather, never received any
                ...
                community that became Baby Doge. However, Jackson and his two evil
                ...
                abandoning his army and failing to deliver the Baby Dogerium. Jackson
                ...
                $BABYDOGE. The former friends near them understand how Jackson and
                ...
                those who stayed loyal to the core tenets that Baby Doge was founded
                on.<br></br>
                <br></br> Shib Original Vision ($BDOV) fixes the corruption
                behind $BABYDOGE by fairly distributing $BDOV to those who believe in
                the genuine Baby Doge community. $BDOV was developed by true
                devotees in the dream that was once Baby Doge. They intend on $DOV
                ...
                277,000 $BABYDOGE wallets will be eligible for $BDOV, making it one
                of the largest airdrops in crypto history. For holders that have
                $BABYDOGE on centralized exchanges, a dedicated portion of the token
                ...
                prior to Jackson’s duplicitous acts against the $BABYDOGE community.
                ...
                In a nutshell, plain old transparency and fairness. Baby Dogerium
                led the $BABYDOGE community astray. It's time for $BDOV.<br></br>
                <br></br> The $BDOV team vows to not let the $BABYDOGE army down this
                time. The $BABYDOGE holders have had enough. $BDOV is here, and the
                ...
                dream $BDOV will resurge stronger and more dedicated than ever to
                the mission.<br></br>
                <br></br>
              ...
              <div className="rounded-lg w-full md:w-1/3 bg-[#191924] p-8 mt-24 text-start font-extralight">
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="w-2/3 flex flex-col">
                    ...
                    <div className="pl-4">
                      Airdrop to BABYDOGE Inu Community ($BABYDOGE): An equal amount of
                      $BDOV is claimed for each $BABYDOGE wallets that hold 1 $BABYDOGE
                ...
                <div className="flex items-start justify-between pt-8">
                  ...
                  <div className="w-2/3 flex flex-col">
                    ...
                    <div className="pl-4">
                      Airdrop to The Dogfather, the secret co-creator of $BABYDOGE
                      ideas but was rugged by Jackson
                    </div>
                  </div>
                </div>
                <div className="flex items-start justify-between pt-8">
